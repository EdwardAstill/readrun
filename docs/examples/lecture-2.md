...
Building on [Lecture 1](./lecture-1.md), this page covers defining and using functions.
...
Here's a slightly more involved example combining functions, lists, and dictionaries from [Lecture 1](./lecture-1.md):
...
- **Runnable Python** with inline output ([Code](../authoring/code.md))
- **Links between pages** that work as site navigation
- **Settings** (gear icon, top-right) for font size, width, and sidebar

To use readrun with your own notes, see the [getting started tutorial](../start/intro.md).
